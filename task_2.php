<?php
    $content = [
        [
            ...
            "description" => "Your privacy is important to us at SmartAdmin and the protection, confidentiality and 
        ...
        [
            ...
            "description" => "We collect certain data through cookies and similar technologies (e.g. web beacons, tags, 
            ...
            track visitor use of the website and to compile statistical reports on website activity. 
            We register your interaction with our services in order to improve our website, content and 
                        ...
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php foreach ($content as $elem): ?>
                                    <h<?php echo $elem['header']['tag']; ?>><?php echo $elem['header']['title']; ?></h<?php echo $elem['header']['tag']; ?>>
